...
const FollowCursor = ({
  ...
  return (
    <div className={`container ${className}`} ref={containerRef}>
      <animated.div
        ref={domTarget}
        className="relative absolute w-[180px] h-[150px] bg-cover rounded-[15px] shadow-[0px_10px_30px_-5px_rgba(0,0,0,0.3)] transition-shadow transition-opacity duration-500 [will-change:transform] touch-none"
        style={{
          width: cardWidth,
